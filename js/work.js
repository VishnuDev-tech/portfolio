...
(function ($) {
  ...
  /------------------------------------------------------*/
	...
	$(document).ready(function ($) {
  	...
  	/  Portfolio Filter
  	/------------------------------------------------------*/
		var $grid = $(".portfolio-box1").isotope({
			// options
			masonry: {
				columnWidth: ".portfolio-box1 .portfolio-sizer1",
				gutter: ".portfolio-box1 .gutter-sizer",
			},
			itemSelector: ".portfolio-box1 .portfolio-item-1",
